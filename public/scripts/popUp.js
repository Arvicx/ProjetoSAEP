...
document.getElementById('formLogin').addEventListener('submit', (event) => {
    ...
    const usuario = document.getElementById('usuario').value; // Obtém o valor do input
    const password = document.getElementById('password').value; // Corrige o ID
    ...
    fetch(URL, {
        ...
        .then((data) => {
            ...
            //const pass = localStorage.getItem('logado');
